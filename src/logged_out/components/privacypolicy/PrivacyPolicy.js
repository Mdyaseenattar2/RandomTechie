...
function PrivacyPolicy(props) {
  const { classes, selectPrivacyPolicy } = props;
  ...
  return (
    ...
    >
      <div className={classes.aboutContentWrapper}>
        <Grid spacing={3}>
          <Typography align="center" variant="h4" style={{ fontWeight: 500 }}>
            Privacy Policy
          </Typography>
        </Grid>
                    ...
                    >
                      <div>
                        <Typography variant="h4" fontWeight="500">
                          Random Techie Privacy Policy (randomtechie.com)
                        </Typography>
                      </div>
                      <p>
                        <i>Last Updated May 2, 2018.</i>
                      </p>
                      <p>
                      ...
                      <p>
                        <li>
                          Processing is lawful, fair, transparent. Our
                          Processing activities have lawful grounds. We always
                          consider your rights before Processing Personal Data.{" "}
                        </li>
                        <li>
                          We will provide you information regarding Processing
                          upon request.
                        </li>
                        <li>
                        ...
                        <li>
                          Processing is limited with a time period. We will not
                          store your personal data for longer than needed.
                        </li>
                        <li>
                      ...
                      <p>
                        <div>
                          1 . Right to information – meaning you have to right
                          to know whether your Personal Data is being processed;
                          what data is gathered, from where it is obtained and
                          why and by whom it is processed.
                        </div>
                        <div>
                          2 . Right to access – meaning you have the right to
                        ...
                        <div>
                          3 . Right to rectification – meaning you have the
                          right to request rectification or erasure of your
                          Personal Data that is inaccurate or incomplete.
                        </div>
                        <div>
                          4 . Right to erasure – meaning in certain
                          circumstances you can request for your Personal Data
                          to be erased from our records.
                        </div>
                        <div>
                          5 . Right to restrict processing – meaning where
                      ...
                      <p>
                        <b>Information you have provided us with </b>
                        <br></br>
                        This might be your e-mail address, name, billing
                        address, home address etc – mainly information that is
                        necessary for delivering you a product/service or to
                        enhance your customer experience with us. We save the
                        information you provide us with in order for you to
                        comment or perform other activities on the website. This
                        information includes, for example, your name and e-mail
                        address.
                      </p>

                      <p>
                        <b>Information automatically collected about you </b>
                        <br></br>
                        This includes information that is automatically stored
                        by cookies and other session tools. For example, your
                        shopping cart information, your IP address, your
                        shopping history (if there is any) etc. This information
                        is used to improve your customer experience. When you
                        use our services or look at the contents of our website,
                        your activities may be logged.
                      </p>

                      <p>
                        <b>Information from our partners </b>
                        <br></br>
                        ...
                        provided them directly with or that they have gathered
                        about you on other legal grounds. See the list of our
                        partners here.
                      </p>
                      ...
                      <p>
                        We may collect information when you engage in any of the
                        following behaviors on our website:
                      </p>
                      ...
                      <p>
                        ...
                        <li>
                          Click-to-call or otherwise engage with communication
                          through our website.
                        </li>
                      </p>
                      ...
                      <p>
                        <li>
                          ...
                          registering your account; providing you with other
                          products and services that you have requested;
                          providing you with promotional items at your request
                          and communicating with you in relation to those
                          products and services; communicating and interacting
                          with you; and notifying you of changes to any
                          services;
                        </li>
